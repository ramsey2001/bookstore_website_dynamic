...
?>
    ...
    <body>
        ...
        <nav class="navprofilo">
            <a style="color: #0f3f4b; text-decoration: none;" href="listauser.php"> Visualizza Utenti </a> <br> <br>
            <a style="color: #0f3f4b; text-decoration: none;" href="lista_libri.php"> Visualizza Libri </a> <br> <br>
